    ...
    return(
        <div className='news'>
            <div className='news__creator'>
                <form id='newPost' onChange={ newsStore.changeForm }>
                    <input className='news__creator--name' name='title' form='newPost' type='text' placeholder='Названьице' />
                    <textarea className='news__creator--content' name='content' form='newPost' type='text' placeholder='Новостюхи, сплетни, пожелания(не рекомендую), предложения(не-а)...'/>
